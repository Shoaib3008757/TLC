...
/**
 * Created by Hafiz Adeel on 8/10/2016.
 */
public class InsuranceCustomAdapter extends BaseAdapter {
    private ArrayList<ImageAndText> mListItems;
    private LayoutInflater mLayoutInflater;
    Context context;

    public InsuranceCustomAdapter(Context context, ArrayList<ImageAndText> arrayList){
    ...
    public View getView(final int position, View view, ViewGroup viewGroup) {
        ...
        if (view == null) {
            ...
            holder.itemImage = (ImageView) view.findViewById(R.id.list_image);
        ...
        ImageAndText stringItem = mListItems.get(position);
        if (stringItem != null) {
            //set the item name on the TextView
            holder.itemName.setText(stringItem.getText());
            holder.itemImage.setImageResource(stringItem.getImage());
        } else {
